...
description: "Проверка вызовов общих модулей BSL по XML-выгрузке конфигурации 1С — существует ли модуль и экспортный ли метод. Применять при переименовании методов, проверке BSL-кода перед коммитом и миграции БСП."
---
