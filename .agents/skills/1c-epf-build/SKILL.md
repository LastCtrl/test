---
name: 1c-epf-build
description: "Сборка внешних обработок (EPF) и отчётов (ERF) из XML-исходников пакетным запуском платформы 1С. Применять для сборки без EDT/Конфигуратора и автоматизации в CI/CD."
---
