...
description: "Справочник паттернов компоновки управляемых форм 1С: архетипы форм, именование, иерархия групп, события. Применять при проектировании и модификации управляемых форм."
---
