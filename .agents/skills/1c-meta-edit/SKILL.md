---
name: 1c-meta-edit
description: "Точечное редактирование XML объектов метаданных 1С: реквизиты, табличные части, измерения, ресурсы, формы, макеты, команды. Применять для атомарных правок метаданных без платформы и EDT."
---
