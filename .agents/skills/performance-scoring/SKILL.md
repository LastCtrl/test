...
description: "Протокол оценки производительности агентов: метрики времени отклика и качества. Применять при выставлении оценок и построении рейтинга моделей."
---
