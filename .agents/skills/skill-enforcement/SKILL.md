...
description: "Мета-скилл, обеспечивающий обязательное использование скиллов и MCP-инструментов в каждой задаче. Применять всегда перед началом работы и при делегировании задач."
---
