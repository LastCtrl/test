...
- [ ] ⚠️ /sync — команда есть, автозаполнение activeContext требует прогона
...
- [ ] ⚠️ /team-report — шаблон есть, зависит от наполнения шины
...
2. Task tool самой сессии принимает только built-in типы (general/explore); именованные агенты — через CLI-делегацию или в TUI пользователя
