...
- **Платные API запрещены.** Все решения проверяются на совместимость с бесплатными моделями (glm-5.3-free (mimo недоступен: квота opencode исчерпана), nemotron-3.5-lightning-free, opencode/nemotron-3-ultra-free).
...
- GitHub/GitLab токен
- **ПРОВЕРИТЬ:** совместимость с бесплатными моделями (opencode/nemotron-3-ultra-free, glm-5.3-free (mimo недоступен: квота opencode исчерпана))
...
2. **Платные API запрещены** — все решения проверяются на совместимость с бесплатными моделями (glm-5.3-free (mimo недоступен: квота opencode исчерпана), nemotron-3.5-lightning-free, opencode/nemotron-3-ultra-free). Если требует платный API — отклоняется.
